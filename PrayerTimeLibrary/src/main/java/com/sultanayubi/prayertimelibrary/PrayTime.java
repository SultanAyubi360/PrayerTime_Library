package com.sultanayubi.prayertimelibrary;
...
public class PrayTime {
    ...
    public String getLocationInfo(Context context, double latitude, double longitude) {
        ...
        try {
            ...
            if (addresses != null && !addresses.isEmpty()) {
                ...
                String cityName = address.getLocality(); // Get city name
                String countryName = address.getCountryName(); // Get country name
                return cityName + ", " + countryName; // Return formatted string
            }
